...
struct UserDetail: HandyJSON {
    ...
    var descriptionHeight: CGFloat { return Calculate.textHeight(text: description, fontSize: 13, height: screenWidth - 30.0) }
...
struct UserDetailDongtai: HandyJSON {
    ...
    var detailConllectionViewH : CGFloat {
        return Calculate.detailConllectionViewHeight(thumb_image_list)
    }
    ...
    var detailContentH: CGFloat {
        return Calculate.textHeight(text: content, fontSize: 17, height: screenWidth - 30.0)
    }
    
    var contentH: CGFloat {
        let height = Calculate.textHeight(text: content, fontSize: 17, height: screenWidth - 30.0)
...
struct DongtaiOriginThread: HandyJSON {
    ...
    var contentH: CGFloat {
        ...
        let height = Calculate.textHeight(text: nameAndContent, fontSize: 17, height: screenWidth - 30.0) + 5.0
...
struct UserDetailQuestion: HandyJSON {
    ...
    var title: String = ""
    var titleH: CGFloat {
        return Calculate.textHeight(text: title, fontSize: 17, height: screenWidth - 30.0) + 5
    }
...
struct UserDetailAnswerContentAbstract: HandyJSON {
    ...
    var textHeight: CGFloat {
        let height = Calculate.textHeight(text: text, fontSize: 16, height: screenWidth - 30.0)
