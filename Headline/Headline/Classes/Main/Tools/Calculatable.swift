...
protocol Calculatable {
    ...
    // 计算文本的宽度
    static func textHeight(text:String,fontSize:CGFloat,height:CGFloat) ->CGFloat
    ...
    // 计算详情里的高度
    static func detailConllectionViewHeight(_ thumbImages:[ThumbImage])-> CGFloat
...
extension Calculatable{
    ...
    static func detailCollectionViewCellSize(_ thumbImages:[ThumbImage])->CGSize{
        ...
        case 1:
            ...
            return CGSize.init(width: (screenWidth - 30), height: height)
        case 2,4: let image2W = (screenWidth - 35) * 0.5
            return CGSize.init(
                width: image2W, height: image2W)
    ...
    /// 计算文本的高度
    static func textHeight(text: String, fontSize: CGFloat, height width: CGFloat) -> CGFloat {
